...
- Any Jupyter environment (open `notebook/retail_ai_location_strategy_gemini_3.ipynb`)
...
This ADK implementation is based on the original Gemini 3 notebook.

**Authors:**
- [Lavi Nigam](https://github.com/lavinigam-gcp)
- [Deepak Moonat](https://github.com/dmoonat)

**Reference Notebook:** `notebook/retail_ai_location_strategy_gemini_3.ipynb`
